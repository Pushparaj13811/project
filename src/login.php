  ...
  <div class="w-full max-w-sm p-4  rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 ">
    <form id="loginForm" class="space-y-6" action="#" method="post">
      ...
      <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
        <a href="signup.php" class="text-blue-700 hover:underline dark:text-blue-500 p-6">Create account</a>
        <a href="forgotPassword.php" class="text-blue-700 hover:underline dark:text-blue-500 p-4">Forgot password?</a>
      </div>
    </form>
  </div>
  <?php
